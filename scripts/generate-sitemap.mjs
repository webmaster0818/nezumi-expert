...
const BASE = "https://nezumi-expert-navi.com";
...
const TIER1 = [
  "nezumi-kuchu-hiyou",
  "nezumi-jibun-de",
  "nezumi-hojo-kin-zenkoku",
];
// Tier 2: 高検索ボリュームの周辺記事
const TIER2 = [
  "nezumi-shurui",
  "nezumi-fun-nyou",
  "nezumi-tenjouura-oto",
  "nezumi-inshokuten-haccp",
  "nezumi-mansion-kanrikumiai",
  "nezumi-kansenshou",
  "nezumi-hokenjo-taiou",
];
