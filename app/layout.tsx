    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-border">
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-foreground/80">
          ...
          <Link
            href="/articles/nezumi-inshokuten-haccp/"
            className="hover:text-primary transition-colors"
          >
            飲食店HACCP
          </Link>
          <Link
            href="/articles/nezumi-mansion-kanrikumiai/"
            className="hover:text-primary transition-colors"
          >
            マンション
          </Link>
          <Link
            href="/articles/nezumi-hojo-kin-zenkoku/"
            className="hover:text-primary transition-colors"
          >
            補助金
          </Link>
        ...
        <details className="md:hidden relative">
          ...
          <div className="absolute right-0 mt-2 w-60 bg-white border border-border rounded-sm shadow-lg py-2 z-50">
            ...
            <Link
              href="/articles/nezumi-jibun-de/"
              className="block px-4 py-2 text-sm hover:bg-muted-bg transition-colors"
            >
              自分で駆除
            </Link>
            <Link
              href="/articles/nezumi-shurui/"
              className="block px-4 py-2 text-sm hover:bg-muted-bg transition-colors"
            >
              ネズミの種類
            </Link>
            ...
            <Link
              href="/articles/nezumi-kansenshou/"
              className="block px-4 py-2 text-sm hover:bg-muted-bg transition-colors"
            >
              感染症リスク
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-white/70 leading-relaxed">
              家庭・飲食店（HACCP対応）・マンション管理組合まで、
              <br />
              用途別に必要な情報を網羅したネズミ駆除の総合ガイドです。
            </p>
          </div>
          <div>
